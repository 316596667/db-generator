...
public class MainMysql {
    public static void main(String[] args) throws Exception {
        ...
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/baobao", "root", "123456");
        ...
        ftUtil.generateFile("/", "moban_2.xml", map, "E:/", "scott2.doc");
    }
